...
class DepartmentListVC: UITableViewController {
    ...
    @IBAction func add(_ sender: Any) {
        ...
        alert.addAction(UIAlertAction(title: "확인", style: .default, handler: { (_) in // 확인 버튼
    ...
    func initUI() {
        ...
        let navTitle = UILabel(frame: CGRect(x: 0, y: 0, width: 200, height: 200))
